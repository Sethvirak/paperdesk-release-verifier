...
def transition_request(raw):
    return {
        ...
        "candidateSha": SHA,
        "candidateRunId": SOURCE_RUN,
        "candidateRunAttempt": SOURCE_ATTEMPT,
...
class ProviderAcceptedReleaseManifestTests(unittest.TestCase):
    ...
    def test_manifest_coordinates_and_production_receipt_digest_fail_closed(self):
        ...
        mutations = (
            ...
            lambda value: value["candidate"].__setitem__("sha", "6" * 40),
            lambda value: value["candidate"].__setitem__("runId", "999"),
            lambda value: value["candidate"].__setitem__("runAttempt", "999"),
